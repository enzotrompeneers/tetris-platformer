...
function gameOver(){
    ...
    //stop
    makeShade();
    game.add.text(game.world.width / 2 - 200, game.world.height / 2 - 400, "Game Over", requireStyle);
...
function gameWon(){
    ...
    //var gameWon = game.add.bitmapText(game.world.centerX, game.world.centerY, 'gameover', 'CONGRATIOLATIONS',40);
